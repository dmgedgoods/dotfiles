...
keymap("n", "<leader>n", "<cmd>Oil<CR>", opts) -- save buffer
...
keymap("n", "<leader><leader>c", "<cmd>noh<cr>", opts)

keymap("n", "<leader>f", "<cmd>lua vim.lsp.buf.format({async = true})<cr>", fopts)

-- move around tabs
keymap("n", "<S-Tab>", "<cmd>tabnext<CR>", fopts)
